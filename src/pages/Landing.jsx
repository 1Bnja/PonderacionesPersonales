    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <nav className="container mx-auto px-6 py-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/register" className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg font-medium transition-colors">
            Registrarse
          </Link>
        </div>
      </nav>
      ...
      <header className="container mx-auto px-6 py-20 text-center lg:text-left lg:flex lg:items-center lg:gap-12">
        <div className="lg:w-1/2 space-y-6">
          <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
            <Link to="/register" className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg shadow-blue-900/20">
              Comenzar Gratis <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/login" className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 px-8 py-4 rounded-xl font-bold text-lg transition-all border border-slate-700">
              Ya tengo cuenta
            </Link>
          </div>
        </div>
        ...
        <div className="hidden lg:block lg:w-1/2 relative">
          ...
          <div className="relative bg-slate-800/50 border border-slate-700 p-6 rounded-2xl shadow-2xl backdrop-blur-sm transform rotate-3 hover:rotate-0 transition-transform duration-500">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-slate-900/50 p-4 rounded-lg border border-slate-700/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-200">Cálculo I</div>
                    <div className="text-xs text-slate-500">4 Créditos</div>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center bg-slate-900/50 p-4 rounded-lg border border-slate-700/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-200">Física Mecánica</div>
                    <div className="text-xs text-slate-500">6 Créditos</div>
                  </div>
                </div>
                <div className="text-right">
               ...
               <div className="flex justify-between items-center bg-slate-900/50 p-4 rounded-lg border border-slate-700/50 opacity-50">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-slate-700 text-slate-400 rounded-lg"><Zap size={20}/></div>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="bg-gradient-to-br from-blue-900/50 to-slate-900 border border-blue-500/30 rounded-3xl p-12 relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">¿Listo para organizar tu semestre?</h2>
            <p className="text-slate-300 mb-8 max-w-xl mx-auto">
              Únete a otros estudiantes que ya están gestionando sus notas de forma inteligente.
            </p>
            <Link to="/register" className="inline-block bg-white text-blue-900 hover:bg-slate-100 px-8 py-4 rounded-xl font-bold text-lg transition-colors">
              Crear cuenta gratis
            </Link>
          </div>
